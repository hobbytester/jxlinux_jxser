...
function functions_for_partner()
	...
	{
		"Chän Pet/Create_Pet",
		"Xãa Pet hiÖn t¹i/Delete_Pet",
		"§æi h×nh Pet hiÖn t¹i/FeaturePet",	
		"§æi tªn Pet hiÖn t¹i/change_name_pet",
		"T¨ng Emotion/IncreaseEmotion",
		"LÊy S¸ch Kh¸ng mçi 12 level, dïng tèi ®a 20 quyÓn/HoiLV",
		"LÊy S¸ch Skill mçi 10 level/SachSkill",
		"Trë L¹i/main",
		"Tho¸t/no",
	}
...
function change_name_pet()
	AskClientForString("DoiTenPet", "PetName", 1, 500, "<#>NhËp tªn pet")
end
...
local tbOpt =
	{
		{"Häc skill TGPH", learn_skill_special},
		...
		{"S¸ch Sinh Lùc",SachSpecial,{868}},
		{"S¸ch Phôc Håi Sinh Lùc",SachSpecial,{869}},
		...
		{"S¸ch T¨ng Hç Trî TÊt C¶ Chiªu",SachSpecial,{884}},
		{"Trë L¹i",Pet},
		{"Tho¸t"},
	}
